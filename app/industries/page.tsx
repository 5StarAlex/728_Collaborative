...
export default function IndustriesPage() {
  return (
    <>
      ...
      <section className="page-hero hero-industries"><div className="container"><p className="eyebrow">Industries</p><h1>Industries Served</h1><p className="large">We support organizations whose work depends on people, systems, learning, care coordination, and community trust.</p><div className="button-row"><Link className="button button-primary" href="/contact">Discuss Your Industry</Link></div></div></section>
